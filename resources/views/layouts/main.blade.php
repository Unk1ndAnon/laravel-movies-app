...
<body class="font-sans bg-gray-900 text-white">
    <nav class="border-b border-gray-800">
        <div class="text-white md:hidden absolute right-0 mr-6 mt-6" id="hamburgerbtn">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-6" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16" />
            </svg>
        </div>
        <div class="container mx-auto justify-between flex-col md:flex-row items-center px-4 py-6 hidden md:flex"
            id="mobileMenu">
